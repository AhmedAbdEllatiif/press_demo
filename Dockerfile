...
RUN cd frappe-bench && \
    ...
    # && \
    # /home/frappe/.local/bin/bench install-app press && \
    # /home/frappe/.local/bin/bench setup requirements && \
    # /home/frappe/.local/bin/bench build --app press
# Get Press app (without building assets yet)

# RUN cd frappe-bench && \
#     if [ ! -d "apps/press" ]; then \
#           /home/frappe/.local/bin/bench get-app --skip-assets --resolve-deps press https://github.com/frappe/press; \
#     fi
